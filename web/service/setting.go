...
var defaultValueMap = map[string]string{
	...
	"subAutoDetectFingerprint":         "false",
	"subApplyDefaultFingerprintAlways": "false",
...
func (s *SettingService) GetSubAutoDetectFingerprint() (bool, error) {
	return s.getBool("subAutoDetectFingerprint")
}

func (s *SettingService) GetSubApplyDefaultFingerprintAlways() (bool, error) {
	return s.getBool("subApplyDefaultFingerprintAlways")
}
